...
var TJ = {
  GAS:      'https://script.google.com/macros/s/AKfycbwpgCeGd3pi0EV6JP9eecVOt-jXg2xISidwxJBiezN02PEGJxDk7vnXhHCTBBuM8lPaOw/exec',
...
async function tjPost(action, data) {
  try {
    ...
    return await r.json();
  } catch(e) { console.warn('[TJ POST]', action, e.message); return null; }
}
